...
class BaseModelAnalyzer:
    def __init__(self, model_id, hardware, config_file=None):
        ...
        logger.info(f"use config file {config_file} for {model_id}")
        self.model_params = loadModelParams(model_id)
    ...
    def get_hardware_info(self):
        ...
        #TODO: consider INT4/2/1 performance
    ...
    def get_model_info(self):
        info = {"GQA": (
            self.config.get_num_attention_heads(self.model_params) != 
...
class LLMAnalyzer(BaseModelAnalyzer):
    def __init__(self, model_id, hardware, config_file=None):
        super().__init__(model_id, hardware, config_file)
...
class MoEAnalyzer(BaseModelAnalyzer):
    def __init__(self, model_id, hardware, config_file=None):
        super().__init__(model_id, hardware, config_file)
...
class VLMAnalyzer(BaseModelAnalyzer):
    def __init__(self, model_id, hardware, config_file=None):
        super().__init__(model_id, hardware, config_file)

class YOLOAnalyzer(BaseModelAnalyzer):
    def __init__(self, model_id, hardware, config_file=None):
        super().__init__(model_id, hardware, config_file)
...
class ModelAnalyzer:
    ...
    def save_csv(self, save_path=None):
        ...
        logger.info(f"save to {decode_file_name} and {prefill_file_name}")
...
def get_analyzer(model_id, hardware, config_path) -> BaseModelAnalyzer:
    params = loadModelParams(model_id)
    ...
    ma = analyzer_class(model_id, hardware, config_path)
    return ma
